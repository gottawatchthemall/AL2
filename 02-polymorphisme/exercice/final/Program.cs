...
namespace _02.HelloPolymorphisme
{
    ...
    public class Lesson
    {
        private readonly DateTime _lessonStartTime;

        public Lesson(DateTime lessonStartTime)
        {
            _lessonStartTime = lessonStartTime;
        }

        public bool IsBreakTime(IClockService clockService)
        {
            return clockService.Now() - _lessonStartTime > TimeSpan.FromMinutes(90);
        }
    }
    ...
    public class Enonce
    {
        ...
        [Fact]
        public void _05_Creer_une_methode_isBreakTime_qui_utilise_IClockService_pour_renvoyer_true_si_le_cours_a_debute_depuis_plus_de_1h30()
        {
            var lessonStartDateTime = DateTime.Now;
        ...
        [Fact]
        public void _06_Renvoyer_false_si_le_cours_a_debute_depuis_moins_de_1h30()
        {
            var lessonStartDateTime = DateTime.Now;
