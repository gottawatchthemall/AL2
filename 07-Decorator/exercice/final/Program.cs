...
namespace _07.Decorator
{
    ...
    class SpecialOffer : ItemDecorator, Item
    {
        private readonly int _percentage;

        public SpecialOffer(Item item, int percentage)
            : base(item)
        {
        ...
        public decimal Price => _item.Price - (_item.Price * _percentage / 100);
    }
